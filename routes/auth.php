...
Route::middleware('guest')->group(function () {
    ...
    Route::get('psicologo', [AuthenticatedSessionController::class, 'create_psicologo'])->name('psicologo');

    Route::post('psicologo', [AuthenticatedSessionController::class, 'store']);
